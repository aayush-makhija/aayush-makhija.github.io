        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          <div>
            <h1 className='text-4xl font-bold tracking-tight text-white sm:text-6xl'>
              Building robust <span className='text-accent'>full-stack</span>{' '}
              digital experiences.
            </h1>
            ...
            <div className='mt-10 flex items-center gap-x-6'>
              ...
              <a
                href='#contact'
                className='text-sm font-semibold leading-6 text-white flex items-center gap-1 hover:text-accent transition-colors'
              >
          ...
          <div className='relative flex justify-center lg:justify-end'>
            <div className='relative h-64 w-64 sm:h-80 sm:w-80 overflow-hidden rounded-2xl bg-secondary shadow-2xl rotate-3 hover:rotate-0 transition-transform duration-500 border border-white/10'>
              <img
                src={photo}
                alt='Aayush Makhija'
                className='h-full w-full object-cover object-[center_90%] transition-all duration-700'
              />
            </div>
            {/* Decorative element */}
