...
const socialLinks = [
  ...
  { name: 'LinkedIn', href: 'https://www.linkedin.com/in/aayush-makhija-80a641253/', icon: Linkedin },
  { name: 'Instagram', href: 'https://www.instagram.com/aayush_makhija/', icon: Instagram },
]
      ...
      <div className="mx-auto mt-16 max-w-xl sm:mt-20">
        <div className="flex flex-col items-center gap-y-16">
          ...
          <div className="text-center">
            <p className="text-xs font-mono font-bold uppercase tracking-[0.3em] text-slate-500 mb-4">Or reach me directly at</p>
            <a 
